...
class NewApplicationPage extends StatefulWidget {
  @override
  _NewApplicationPage createState() => _NewApplicationPage();
}

class _NewApplicationPage extends State<NewApplicationPage> {
                                      ...
                                      children: <Widget>[
                                        ...
                                        new InkWell(
                                            ...
                                            child: new Container(
                                                ...
                                                child: new Text("Submit Form", style: new TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.bold, decoration: TextDecoration.underline),)
                                            )
                                        )
                                      ]
                                  )
